...
(function(){
  ...
  // Route clicks on the visible Next/Prev links through the pager so a mouse
  // click steps through a chapter's spreads instead of jumping to the next file.
  ...
  // "Copy prompt" for image slots (plain-browser convenience; the app wires this too).
  document.addEventListener('click', function(e){
