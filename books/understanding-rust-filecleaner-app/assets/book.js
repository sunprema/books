/* Two-page-spread pager for BookBank. Self-contained; works from file://.
   ...
   Dispatches 'bookbank:relayout' after every layout() so canvas widgets
   (assets/vendor/book-widgets.js + assets/widgets.js) re-fit their canvases,
   and 'bookbank:spread' on every render() with the current {i,total}. */
(function(){
  ...
  // else a mouse click skips the chapter's remaining spreads.
