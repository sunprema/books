/* book.js — two-page-spread pager for "Spring — A Simple Intro".
   Contract kept from the BookBank reference pager: window.bookbankPager with
   next/prev/home, a bookbank:relayout event after every layout, and a
   bookbank:spread event on every render so book-progress.js can see position. */
(function(){
  ...
  // Same 900px breakpoint as the CSS. Below it there is no spread to paginate.
  ...
  function contentRight(){
    ...
    // child rects (engine-proof, and invariant while translated/animating).
  ...
  function layout(){
    ...
    // Measure against the leaf's CONTENT box: subtract its own horizontal
    // padding, or two columns + the gap won't fit and Chrome collapses to one.
  ...
  // Plain-browser keys only; the app sets __bookbankNav and handles keys itself.
  ...
  // REQUIRED — route Next/Prev clicks through the pager, or a mouse click
