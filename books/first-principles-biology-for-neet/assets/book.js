/* First Principles Biology for NEET — two-page-spread pager.
   Exposes window.bookbankPager {next,prev,home}. The BookBank app binds
   arrow keys to it; the keydown handler below is for plain-browser use only
   and defers to the app when window.__bookbankNav is set. */
(function(){
